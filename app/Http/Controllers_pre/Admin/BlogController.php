...
class BlogController extends Controller
{
    ...
    {	
        ...
        return view($this->module_view_folder.'.blog_list',$data);
	...
	public function store(Request $request)
	{
        ...
        $sub_description2 = $request->input('sub_description2');
		...
		$arr_data['sub_title2']		=	$sub_title2;	
		$arr_data['sub_description2']		=	$sub_description2;
