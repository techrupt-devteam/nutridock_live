        ...
        <ul class="row p-0 mb-0">
          <li class="col-twelve mt-2" style="list-style: none;">
            <div class="ginput_container ginput_container_email">
              <a href="https://rushabh2w.com/nutridock_register">
              <div class="left"></div>
              Register Now
              <div class="right"></div>
              </a>
...
function submitData(){
    ...
    type:"POST",
    data:{
      name:name_value,email:email_value,mobile:mobile_value,age:age_value,city:city_value,_token: token
    },
