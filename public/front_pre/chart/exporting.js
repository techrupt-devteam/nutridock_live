...
(function (c) {
        ...
        h = (function () {
            ...
            c.prototype.setButtonText = function () {
                ...
                (null === k || void 0 === k ? 0 : k.menuItemDefinitions) &&
                    ...
                    h &&
                    h.length &&
                    (h[l.indexOf("viewFullscreen")].innerHTML = this.isOpen ? e.exitFullscreen : k.menuItemDefinitions.viewFullscreen.text || e.viewFullscreen);
            };
    ...
    p(c, "modules/exporting.src.js", [c["parts/Chart.js"], c["mixins/navigation.js"], c["parts/Globals.js"], c["parts/Options.js"], c["parts/SVGRenderer.js"], c["parts/Utilities.js"]], function (c, l, h, k, p, e) {
        ...
        n(!0, k.navigation, {
            ...
            menuItemStyle: { padding: "0.5em 1em", color: "#333333", background: "none", fontSize: H ? "14px" : "11px", transition: "background 250ms, color 250ms" },
        ...
        w(c.prototype, {
            sanitizeSVG: function (a, b) {
                ...
                b &&
                    ...
                    d &&
                    ((d = '<foreignObject x="0" y="0" width="' + b.chart.width + '" height="' + b.chart.height + '"><body xmlns="http://www.w3.org/1999/xhtml">' + d + "</body></foreignObject>"), (a = a.replace("</svg>", d + "</svg>")));
                a = a
                    .replace(/zIndex="[^"]+"/g, "")
            ...
            exportChart: function (a, b) {
                ...
                h.post(a.url, { filename: a.filename ? a.filename.replace(/\//g, "-") : this.getFilename(), type: a.type, width: a.width || 0, scale: a.scale, svg: b }, a.formAttributes);
            },
            ...
            addButton: function (a) {
                ...
                if (!1 !== d.enabled) {
                    ...
                    if (d.symbol) {
                        var m = f
                            .symbol(d.symbol, d.symbolX - h / 2, d.symbolY - h / 2, h, h, { width: h, height: h })
