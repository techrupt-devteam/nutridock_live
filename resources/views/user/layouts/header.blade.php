...
<ul class="navbar-nav bg-gradient-dark sidebar sidebar-dark accordion" id="accordionSidebar">
  ...
  <?php }else{ ?>
  <li class="nav-item"> <a class="nav-link" href="{{url('')}}/admin/view-subscribe-now"> <i class="fas fa-fw fa-sliders-h"></i> <span>Subscribe Now</span></a> </li>
  ...
  <i class="far fa-fw fa-address-card"></i> <span>About Us</span> </a>
    <div id="collapseOne" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
      ...
      <!--<a class="collapse-item" href="{{url('')}}/admin/view-our-chefs">Our Chefs</a>--> </div>
    </div>
  </li>
  <!--<li class="nav-item"> <a class="nav-link" href="{{url('')}}/admin/view-blog"> <i class="fas fa-fw fa-photo-video"></i> <span>Blog</span></a> </li>-->
  ...
  <!--<li class="nav-item">
        <a class="nav-link" href="{{url('')}}/admin/view-menu">
