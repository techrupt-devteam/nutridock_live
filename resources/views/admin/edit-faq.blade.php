...
<!-- Begin Page Content -->
    <div class="container-fluid">
      <div class="card shadow mb-4">
            ...
            <div class="card-body">
                <form  action="{{url('')}}/admin/faq/update/{{ base64_encode($arr_data['id']) }}" method="post" enctype="multipart/form-data" onsubmit="return submitData()">
                {{csrf_field()}}
                <div class="row">
                    <div class="col-lg-8">
                        <div class="row">
                            <div class="col-lg-12 mb-3">
                                ...
                                <input type="text" class="form-control" name="title" value="{{$arr_data['title'] ?? ''}}" placeholder="Title" required="required">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-12">
                        <div class="row">
                             <div class="col-lg-12 mb-3">
                                ...
                                <textarea rows="4" id="editor1" class="form-control w-100 editor_value" name="description" placeholder="Description" required="required">{{$arr_data['description'] ?? ''}}</textarea>
                            </div>
