...
<!-- Begin Page Content -->
    <div class="container-fluid">
      ...
      <div class="card shadow mb-4">
            ...
            <div class="card-body">
                <form  action="{{url('/')}}/admin/subscription/email/{{base64_encode($arr_data['id'])}}" method="post" enctype="multipart/form-data">
                {{csrf_field()}}
                <div class="row">
                    <div class="col-lg-6">
                        <div class="row">
                        <div class="col-lg-12 mb-3">
                            ...
                            <input type="text" class="form-control" value="{{$arr_data['email'] ?? ''}}" name="email" placeholder="Title" required="required">
                        </div>
                        </div>
                        <div class="row">
                            <div class="col-lg-12 mb-3">
                 ...
                 <div class="col-lg-6">
                    <div class="col-lg-12 mb-3">
                        ...
                        <textarea rows="5" class="form-control w-100" name="message" placeholder="Message"></textarea>
                    </div>
                </div>
