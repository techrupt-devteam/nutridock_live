    ...
    <div class="container-fluid">
      ...
      <div class="card shadow mb-4">
            <div class="card-header py-3">
              ...
              <a href="{{url('')}}/admin/view-our-services" class="btn btn-dark btn-sm float-right" data-toggle="tooltip" title="Back"><i class="fas fa-long-arrow-alt-right"></i></a>
            </div>
            <div class="card-body">
                <form  action="{{url('/')}}/admin/ourservices/update/{{ base64_encode($arr_data['id']) }}" method="post" enctype="multipart/form-data">
                {{csrf_field()}}
                <div class="row">
                    <div class="col-lg-6">
                     ...
                     <div class="col-lg-6">
                        ...
                        <div class="col-lg-6 mb-3">
                            <label class="label-control">Icon Image <span style="color:red;">*</span></label>
                            <input type="file" class="form-control" name="icon_image" onchange="view_image(this, '<?php echo $arr_data['id']; ?>');" id="p_image_<?php echo $arr_data['id']; ?>">
                             <!--@if($arr_data['icon_image'])
                                <a href="{{url('')}}/uploads/images/{{$arr_data['icon_image']}}" target="_tab">View Image</a>
                            @endif-->
                        </div>
                ...
                <div class="col-lg-12" style="text-align: center;">
                    ...
                    <button class="btn btn-primary btn-md mr-2" name="sumbit" type="sumbit" value="submit"> Submit </button>
                     <a href="{{url('')}}/admin/view-our-services" class="btn btn-danger btn-md"> Cancel </a>
                </div>
            </form>
