...
<!-- Begin Page Content -->
    <div class="container-fluid">
      ...
      <div class="card shadow mb-4">
            ...
            <div class="card-body">
                <form  action="{{url('/')}}/admin/ourservices/store" method="post" enctype="multipart/form-data">
                {{csrf_field()}}
                <div class="row">
                    <div class="col-lg-6">
                     ...
                     <div class="col-lg-6">
                        <div class="col-lg-12 mb-3">
                            ...
                            <input type="file" class="form-control" name="icon_image" required="required">
                        </div>
                    </div>
                </div>
