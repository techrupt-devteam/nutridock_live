...
<!-- Begin Page Content -->
    <div class="container-fluid">
      ...
      <div class="card shadow mb-4">
            ...
            <div class="card-body">
                <form  action="{{url('/')}}/admin/healthyfarm/update/{{ base64_encode($arr_data['id']) }}" method="post" enctype="multipart/form-data">
                {{csrf_field()}}
                <div class="row">
                    <div class="col-lg-6">
                        <div class="row">
                            <div class="col-lg-12 mb-3">
                                ...
                                <input type="text" class="form-control" name="description" placeholder="Description" value="{{ $arr_data['description'] ?? ''}}">
                            </div>
                            <div class="col-lg-12 mb-3">
                                <label class="label-control">Title <span style="color:red;">*</span></label>
                                <input type="text" class="form-control" name="title" placeholder="Title" value="{{ $arr_data['title'] ?? ''}}" required="required">
                            </div>
                        </div>
                    </div>
