...
<main>
  ...
  <!-- The Modal -->
@foreach($cate_data as $key => $row)
<?php $id=$row->id;$menu_data=\DB::table('menu')->get();foreach($menu_data as $menu_row): ?>
            ...
            <div class="modal-body" style="background-color: #f7f7f7;">
              <div>
                <ul class="list-inline mb-0" data-test="tags">
                  <?php $menu_data_id=$menu_row->id;$menu_data=\DB::table('menu')->where('id',$menu_data_id)->get();foreach($menu_data as $menu_row);$speci=$menu_row->specification;$abc=explode(",",$speci);for($i=0;$i<count($abc);$i++){ ?>
              ...
              <div class="MealModal-module">
                <article class="meals-overlay">
                 <div>
                    <div class="row">
                      <div class="col-md-5">
                      <?php $mult_image=$menu_row->multiple_image;$exp=explode(",",$mult_image);for($i=0;$i<count($exp);$i++){ ?>
                     ...
                     <div class="col-md-7">
                      ...
                      <section class="title-wrap">
                        ...
                        <div class="row m-0">
                          <?php $menu_id=$menu_row->id;$ingredients=\DB::table('ingredients')->where('menu_id',$menu_id)->limit(6)->get();foreach($ingredients as $ingredients_value): ?>
                    ...
                    <div id="demo" class="collapse">
                      <div class="heading-title-">
                       <h2 class="pl-3" style="margin-bottom: -9px;">
                        ...
                        <?php $name=array();$menu_value_id=$menu_row->id;$ingredients=\DB::table('ingredients')->where('menu_id',$menu_value_id)->get();foreach($ingredients as $ingredients_value1){$name[]=$ingredients_value1->name;}$array=implode(',',$name); ?>
                       ...
                       <section class="title-wrap">
                        ...
                        <div class="row">
                          <?php $menu_id=$menu_row->id;$whats_inside=\DB::table('whats_inside')->where('menu_id',$menu_id)->orderby('id','ASC')->limit(4)->get();foreach($whats_inside as $whatsinside_row):$title=$whatsinside_row->title; ?>
                    ...
                    <div id="demo2" class="collapse">
                      ...
                      <table class="table">
                         <?php $menu_id=$menu_row->id;$whats_inside=\DB::table('whats_inside')->where('menu_id',$menu_id)->orderby('id','ASC')->get();foreach($whats_inside as $whatsinside_row):$title=$whatsinside_row->title; ?>
                        <tr>
                          <th>
